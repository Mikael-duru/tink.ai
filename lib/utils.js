...
export const improveWithAIPrompt = ({ type, userIndustry, title, current }) => {
	...
	**Requirements:**
	...
	- **Improve and clarify** the description to **align with the title and industry expectations**. **Keep it concise yet detailed (ideally within 1-5 sentences) and do not mention the title in the description**, avoiding unnecessary filler.
